...
const categories = [
  ...
  },
  {
    ...
    description: "Trackers and lists I actually use — log calories, manage the grocery run, and follow my body metrics over time.",
    topics: ["Calorie Tracker", "Grocery List", "My Metrics"],
